    ...
    <div className="flex flex-col gap-4 border-neutral-800 bg-black p-4 border rounded-lg">
      ...
      <form action={submit} className="flex flex-col gap-3">
        ...
        <PassField
          ...
          error={state?.code === "wrong-password" ? "Wrong password" : undefined}
        />
        <div className="flex gap-[inherit] w-full">
          <button type="button" className="flex-1 border-neutral-800 bg-neutral-950 px-4 py-2 border rounded text-neutral-400">
            Go Back
          </button>
